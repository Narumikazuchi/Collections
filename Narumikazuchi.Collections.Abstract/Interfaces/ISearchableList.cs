namespace Narumikazuchi.Collections.Abstract
{
    ...
    public interface ISearchableList<T> : IReadOnlyList2<T>, ISearchableCollection<T>
    {
        ...
        /// </summary>
        /// <remarks>
        /// If the <see cref="ISearchableList{T}"/> is not previously sorted, this method will sort it before searching.
        /// </remarks>
        ...
        /// <summary>
        /// Searches the sorted <see cref="ISearchableList{T}"/> for the specified item using the specified <see cref="System.Collections.Generic.IComparer{T}"/>.
        /// </summary>
        /// <param name="item">The item to search.</param>
        ...
        [System.Diagnostics.Contracts.Pure]
        public System.Int32 FindIndex([System.Diagnostics.CodeAnalysis.DisallowNull] System.Func<T, System.Boolean> predicate);
        /// <summary>
        /// Searches the specified range in the <see cref="ISearchableList{T}"/> for an item matching the specified condition and
        /// returns the index of the first occurence of a matching item.
        /// </summary>
        ...
        [System.Diagnostics.Contracts.Pure]
        public System.Int32 FindLastIndex([System.Diagnostics.CodeAnalysis.DisallowNull] System.Func<T, System.Boolean> predicate);
        /// <summary>
        /// Searches the specified range in the <see cref="ISearchableList{T}"/> for an item matching the specified condition and
        /// returns the index of the last occurence of a matching item.
        /// </summary>
