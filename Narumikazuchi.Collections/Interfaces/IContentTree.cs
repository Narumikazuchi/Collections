namespace Narumikazuchi.Collections
{
        ...
        where TContent : class
    {
        ...
        public System.Boolean Insert([System.Diagnostics.CodeAnalysis.DisallowNull] TValue value, 
                                     [System.Diagnostics.CodeAnalysis.DisallowNull] TContent content);
        /// <summary>
        /// Inserts the specified value into the <see cref="IContentTree{TNode, TValue, TContent}"/> and adds the specified content to the resulting node.
        /// </summary>
        /// <param name="value">The value to be inserted.</param>
        /// <param name="content">The content to add to the resulting node.</param>
        public System.Boolean Insert([System.Diagnostics.CodeAnalysis.DisallowNull] TValue value, 
                                     [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEnumerable<TContent> content);
        /// <summary>
