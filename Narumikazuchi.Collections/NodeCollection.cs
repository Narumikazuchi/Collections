...
namespace Narumikazuchi.Collections
{
    ...
    /// </summary>
    public sealed class NodeCollection<TNode, TContent> : ReadOnlyRegister<TNode> 
        where TNode : ITreeNode<TNode, TContent>
    {
        internal NodeCollection(EqualityComparison<TNode> comparison) : 
            base(comparison) => 
                this._items = new TNode[1];
