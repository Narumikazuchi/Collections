    ...
    where TComparer : IComparer<TElement>
{
    ...
    public static ReadOnlySortedCollection<TElement, TComparer> CreateFrom<TEnumerable>(
    ...
    /// <param name="comparer">The comparer that will be used to compare two instances of type <typeparamref name="TElement"/>.</param>
    /// <exception cref="ArgumentNullException" />
    public static ReadOnlySortedCollection<TElement, TComparer> CreateFrom<TEnumerable, TEnumerator>(
#if NETCOREAPP3_0_OR_GREATER || NETSTANDARD2_1_OR_GREATER
        [DisallowNull]
#endif
        TEnumerable items,
